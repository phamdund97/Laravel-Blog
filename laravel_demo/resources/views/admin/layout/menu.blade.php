<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin/layout/index"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
            </li>
            <li>
            ...
            <li>
                <a href=""><i class="fa fa-h-square fa-fw"></i> Loại Tin<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href=""><i class="fa fa-recycle fa-fw"></i>Tin Tức<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
